...
class Blackboard:
    ...
    def environment(self) -> Iterable[Tuple[EnvironmentKeyType, Any]]:
        """
        Return all the environment variables stored in the blackboard.

        :return: The iterable set of tuples for the environment variables
        """
    ...
    def states(self) -> Iterable[Tuple[NodeIdType, Any]]:
        """
