...
from .common import NodeIdType, STATE_NODE_RESULT, STATE_ADDITIONAL_INFORMATION, ResultEnum, STATE_NODE
...
class TreeNode:
    ...
    __name: str  # Human-readable name of the node
    ...
    def additional_information(self, blackboard: Blackboard, default_value: Optional[Any]) -> Any:
        ...
        if blackboard.is_in_states(self.__id):
            ...
            if STATE_ADDITIONAL_INFORMATION in state:
                result = blackboard.get_in_states(self.__id)[STATE_ADDITIONAL_INFORMATION]
    ...
    def report_failed(self, blackboard: Blackboard, additional_information: Any = None):
        ...
        blackboard.set_in_states(
            ...
            {
                STATE_NODE: self,
                STATE_NODE_RESULT: ResultEnum.FAILED,
    ...
    def report_running(self, blackboard: Blackboard, additional_information: Any = None):
        ...
        blackboard.set_in_states(
            ...
            {
                STATE_NODE: self,
                STATE_NODE_RESULT: ResultEnum.RUNNING,
                STATE_ADDITIONAL_INFORMATION: additional_information
            }
        )
    ...
    def report_succeeded(self, blackboard: Blackboard, additional_information: Any = None):
        ...
        blackboard.set_in_states(
            ...
            {
                STATE_NODE: self,
                STATE_NODE_RESULT: ResultEnum.SUCCEEDED,
                STATE_ADDITIONAL_INFORMATION: additional_information
            }
        )
    ...
    def result(self, blackboard: Blackboard) -> ResultEnum:
        ...
        return blackboard.get_in_states(self.__id)[STATE_NODE_RESULT]
